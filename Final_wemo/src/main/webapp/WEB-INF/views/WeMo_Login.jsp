    ...
    <script>
       $(function(){
        ...
        var loginView = '<form action = "IntoWeMo" method ="POST">'
                      ...
                      + '<img src="resources/image/kakaobtn.png" id="kakao-login-btn" width ="30px" role="button"></div>'
                      + '<div id="naverIdLogin" style="display:inline-block" data-toggle="tooltip" title="네이버 아이디로 로그인">'
                      + '<a id="naver-login-btn" href="#" role="button"><img src="resources/image/naver.ico" width="30px"></a></div>'
                      + '<br><button type="submit" class="btn btn-login">메모장 열기</button>'
